...
import "../../../pages/editor_home_page/controllers/editor_home_page_controller.dart";

class EditorHomePageView extends GetView<EditorHomePageController> {
  const EditorHomePageView({super.key});
  ...
  Widget _homeCard(Client client, BuildContext context) {
    return Padding(
      ...
      child: HomeCard(
        ...
        logo: client.logo,
        onTap: () => context.go("/editor-client/${client.id}"),
      ),
    );
  }
      ...
      body: Obx(() {
        ...
        return TransformableListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _homeCard(client, context);
          },
