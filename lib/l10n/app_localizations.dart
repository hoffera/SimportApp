...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginPasswordButton.
  ///
  /// In en, this message translates to:
  /// **'Forgot my password'**
  String get loginPasswordButton;
  ...
  /// Label for the Terms of Service agreement
  ///
  /// In en, this message translates to:
  /// **'Terms of Service'**
  String get termsOfService;

  /// Label for the Privacy Policy agreement
  ///
  /// In en, this message translates to:
  /// **'Privacy Policy'**
